    ...
    return(
        <section id="about" className="py-24 px-4 relative">
            <div className="container mx-auto max-w-5xl">
                <h2 className="text-3xl md:text-5xl fort-bold mb-12 text-center">
                    About
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                    <div className="space-y-6">
                        ...
                        <p className="text-muted-foreground">
                            With an year of experience in web deveoplment, 
                            I specialize in creating responsive, acessible and performant web application 
                            using modern technologies.
                            {/* such as React, Next.js, Tailwind CSS and Node.js. */}
                        </p>
                        <p className="text-muted-foreground">
                            I'm passionate about creating elegant solutions to complex problems, 
                            and I'm constantly learning new trechnologies and techniques 
                            to stay in the forefront of the ever-evolving web landscape.
                        </p>
                        ...
                        <div className="gradient-border p-6 card-hover">
                            <div className="flex items-start gap-4">
                                ...
                                <div className="text-left">
                                    ...
                                    <p className="text-muted-foreground">
                                        Leading projects from conception to completion with agile meathodologies
                                    </p>
                                </div>
                            </div>
                        </div>
